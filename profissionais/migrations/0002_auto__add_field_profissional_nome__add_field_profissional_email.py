...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profissional.nome'
        db.add_column(u'profissionais_profissional', 'nome',
                      self.gf('django.db.models.fields.CharField')(default='Nome', max_length=500),
                      keep_default=False)

        # Adding field 'Profissional.email'
        db.add_column(u'profissionais_profissional', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='admin@admin.com', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profissional.nome'
        db.delete_column(u'profissionais_profissional', 'nome')

        # Deleting field 'Profissional.email'
        db.delete_column(u'profissionais_profissional', 'email')
